									...
									<tbody id="find_park_t">
										...
										<?php
											...
											<?php
                                                    ...
                                                    if (isset($_GET['book_park'])) {
														$date_time = date("Y/m/d");														
                                                        $insert_date_time_query = "INSERT INTO cost_info(parker_id, parker_name, starting_time) VALUES ('$p_id', '$p_uname', '$date_time')";
